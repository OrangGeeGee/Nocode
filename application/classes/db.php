...
class db extends mysqli {
    ...
    */
    public function __construct($mysql=NULL) {
        if(empty($mysql)) require APP_PATH.'/configs/mysql_info.php';
    ...
    * @param ... other parameters that belong in your query's ? spots
    * @access public
    ...
    * @param ... other parameters that belong in your query's ? spots
    * @access public
    * @return array Array with all returned rows
    */     
    public function q() {
        $this->lasterror = "";
    ...
    * @access public
    * @return bool indicates the success or failure. inserted id and affected rows can be fetched from class variables
    */    
